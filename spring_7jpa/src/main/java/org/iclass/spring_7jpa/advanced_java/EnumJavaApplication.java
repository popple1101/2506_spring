...
public class EnumJavaApplication {
    public static void main(String[] args) {
        ...
        System.out.println("----- 모든 DAY 찍어보기 -----");
        ...
        System.out.println("값 4의 요일은?" + Day2.fromNumber(4));
        System.out.println("값 4의 요일은?" + Day2.fromNumber(5));
 ...
 * -> 활용) 스프링 시큐리티에서 사용자의 역할 설정할 때
 * --> HttpStatus.CREATE 는 응답코드를 201 로 보내주는 값
 */